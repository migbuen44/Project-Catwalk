          ...
          <Row>
            {styles.map((style, id) => (
              ...
              >
                ...
                {
                  !style.photos.length ? <img src={altUrl} key={id} className='style'></img>
                    : <img src={style.photos[0].thumbnail_url ? style.photos[0].thumbnail_url : altUrl} key={id} className='style'></img>
                }
              </Col>
            ))}
          </Row>
